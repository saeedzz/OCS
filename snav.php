    ...
    <form class="modal-content" method="POST" action="updateProfile.php" enctype="multipart/form-data">
      ...
      <div class="modal-body">
        ...
        <div class="text-center mb-3">
          <div class="mb-3" id="pincode-container">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="pincode" id="pincode" value="<?php echo $_SESSION['pincode']; ?>">
          <script>
              function generateRandomPincode() {
                  const randomPincode = Math.floor(100000 + Math.random() * 900000);
                  document.getElementById('pincode').value = randomPincode;
              }
          </script>
